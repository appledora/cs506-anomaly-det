...
1. Dataset: Adapt a labeled dataset on CIFAR‑10/100 (or existing anomaly dataset like AlleNoise) where each training image is categorized into one of several anomaly types:
